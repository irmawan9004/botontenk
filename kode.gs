...
var SS_URL = "https://docs.google.com/spreadsheets/d/1nGy2lgswzPfWEWEcnDU1AHKnPHsdsLIKBH3eqYzPqog/edit?hl=id&gid=0"; // URL SPREADSHEET
var CREDIT_SHEET_NAME = "PemasukanOntenk"; // NAMA SHEET PEMASUKAN
var DEBIT_SHEET_NAME = "PengeluaranOntenk"; // NAMA SHEET PENGELUARAN
...
// Pastikan sheet pemasukan dan pengeluaran ada
const creditSheet = createSheetIfNotExists(CREDIT_SHEET_NAME, [
  "_id",
  "_date",
  "Tanggal",
  "Kategori",
...
const debitSheet = createSheetIfNotExists(DEBIT_SHEET_NAME, [
  "_id",
  "_date",
  "Tanggal",
  "Kategori",
